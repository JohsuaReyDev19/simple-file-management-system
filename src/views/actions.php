<div class="flex flex-wrap gap-4 mb-6 items-center justify-between">
    <div class="flex gap-4">
        <button onclick="showModal('createFolderModal')" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">
            <i class="fas fa-folder-plus mr-2"></i>New Folder
        </button>
        <button onclick="showModal('uploadFileModal')" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">
